...
/*
    ...
    REFERENCE TYPES
        ...
        This does not modify "Hello"; s simply refers to another String.      // **Strings are immutable in JAVA.**
    ...
    JAVA VS C++
        Java String       → Immutable(use StringBuilder for heavy string manipulation)
        Java arrays       → Mutable

        C++ std::string   → Mutable
        string s = "Hello";
        s[0] = 'J';       // Modifies the existing string → "Jello"   // BUT INVALID IN JAVA
